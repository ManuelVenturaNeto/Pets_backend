...
def test_route():
    ...
    # testing inputs
    assert (
        find_animal_shelter_use_case.by_id_and_name_param["animal_shelter_id"]
        == http_request.query["animal_shelter_id"]
    )
    assert (
        find_animal_shelter_use_case.by_id_and_name_param["name"]
        == http_request.query["animal_shelter_name"]
    )
