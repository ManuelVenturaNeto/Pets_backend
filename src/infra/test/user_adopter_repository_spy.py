...
from src.domain.test import mock_user_adopter, mock_address
...
class UserAdopterRepositorySpy():
    ...
    def insert_user_adopter(self, name: str, password: str, cpf: str, responsible_name: str, email: str, phone_number: int, address_id: int, pet_id: int) -> UserAdopters:
        """
        Spy to all the attributes
        """
        self.insert_user_adopter_params["name"] = name
        self.insert_user_adopter_params["cpf"] = cpf
        self.insert_user_adopter_params["responsible_name"] = responsible_name
    ...
    def select_user_adopter(self, id: int = None, name: str = None, cpf: str = None, responsible_name: str = None, email: str = None, phone_number: int = None, address_id: int = None, pet_id: int = None) -> List[UserAdopters]:
        """
        Spy to all the attributes
        """
        ...
        self.select_user_adopter_params["responsible_name"] = responsible_name
